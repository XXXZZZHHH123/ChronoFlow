...
public class GroupServiceImpl implements GroupService{
    ...
    public void deleteGroup(Long id) {
        ...
        if (!ObjectUtil.isEmpty(groupMembers)) {
            ...
            List<Long> normalMemberIds = groupMembers.stream()
    ...
    public List<GroupRespVO.MemberInfo> getGroupMembers(Long groupId) {
        ...
        return members.stream()
                .map(user -> GroupRespVO.MemberInfo.builder()
                        .userId(user.getId())
    ...
    public void addMembersToGroup(Long groupId, List<Long> userIds) {
        ...
        log.info("success add members to group: groupId={}, success={}, failed={}",
                groupId, successIds.size(), failedIds.size());
    ...
    public void removeMembersToGroup(Long groupId, List<Long> userIds) {
        ...
        log.info("success to remove members from group: groupId={}, success={}, failed={}",
                groupId, successIds.size(), failedIds.size());
