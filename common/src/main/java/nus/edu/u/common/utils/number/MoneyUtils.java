package nus.edu.u.common.utils.number;
...
public class MoneyUtils {
   ...
   */
  public static BigDecimal calculateRatePrice(
      Number price, Number rate, int scale, RoundingMode roundingMode) {
